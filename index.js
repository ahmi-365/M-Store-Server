...
const endpointSecret = 'whsec_2c45ca9db14792ff20c545c956b0269da301811bb512516f3b04053e69a06bea';
...
app.post('/webhook', express.raw({ type: 'application/json' }), async (req, res) => {
  ...
  if (event.type === 'checkout.session.completed') {
      ...
      try {
          ...
          // Retrieve full session details to get receipt URL
          ...
          const payment = new Payment({
              ...
              receiptUrl: fullSession.receipt_url, // Get receipt URL here
          });
